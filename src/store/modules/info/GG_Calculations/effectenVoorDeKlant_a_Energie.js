...
const ENERGIEBESPARING_GROEN = {
  VERWARMING(isolatieGraad) {
    if (isolatieGraad === 'Goed') {
      return { min: 21, avg: 23, max: 25, eenheid: '%' };
...
export {
  ...
  //AANDACHT: voor het groene dak klopt dit voor groene gevel houd men geen rekening met huidige
  //isolatiewaardes noch met oppervlakte van de groende gevel.
};
